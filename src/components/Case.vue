...
<template>
  ...
  <h1>{{casename}}</h1> 
  <h4><div class="circle"></div> {{casetype}}</h4>
  <p>{{casetext}}</p>

  <a :href="caselink" download> {{caselinktext}}</a>


      <video  v-if="content1 && content1.includes('.mp4')" id="vid1" autoplay loop muted>
        <source :src="content1"  type="video/mp4">
      </video>
      <img v-if="content1 && (content1.includes('.jpg') || content1.includes('.png'))" id="img1" :src="content1" alt="">

      <video  v-if="content2 && content2.includes('.mp4')" id="vid2" autoplay loop muted>
        <source :src="content2" type="video/mp4">
      </video>
      <img v-if="content2 && (content2.includes('.jpg') || content2.includes('.png'))" id="img2" :src="content2" alt="">

      <div id="descr"> 
          <h4>Roles</h4> <span>{{caseroles}}</span>
          <h4>Stakeholders</h4> <span>{{casestakeholders}}</span>
          <h4>Tools</h4> <span>{{casetools}}</span>
      </div>

      <video  v-if="content3 && content3.includes('.mp4')" id="vid3" autoplay loop muted>
        <source :src="content3" type="video/mp4">
      </video>
      <img v-if="content3 && (content3.includes('.jpg') || content3.includes('.png'))" id="img3" :src="content3" alt="">

      <video  v-if="content4 && content4.includes('.mp4')" id="vid4" autoplay loop muted>
        <source :src="content4" type="video/mp4">
      </video>
      <img v-if="content4 && (content4.includes('.jpg') || content4.includes('.png'))" id="img4" :src="content4" alt="">

      <div id="descr"> <p>{{casemore}}</p> <a :href="caselink" download> {{caselinktext}}</a></div>

      <video  v-if="content5 && content5.includes('.mp4')" id="vid5" autoplay loop muted>
        <source :src="content5" type="video/mp4">
      </video>
      <img v-if="content5 && (content5.includes('.jpg') || content5.includes('.png'))" id="img5" :src="content5" alt="">

      <video  v-if="content6 && content6.includes('.mp4')" id="vid6" autoplay loop muted>
        <source :src="content6" type="video/mp4">
      </video>
      <img v-if="content6 && (content6.includes('.jpg') || content6.includes('.png'))" id="img6" :src="content6" alt="">

      <video  v-if="content7 && content7.includes('.mp4')" id="vid7" autoplay loop muted>
        <source :src="content7" type="video/mp4">
      </video>
      <img v-if="content7 && (content7.includes('.jpg') || content7.includes('.png'))" id="img7" :src="content7" alt="">
